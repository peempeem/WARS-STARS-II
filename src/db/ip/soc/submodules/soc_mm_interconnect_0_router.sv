...
(
    ...
    localparam PAD7 = log2ceil(64'h168 - 64'h160); 
    localparam PAD8 = log2ceil(64'h170 - 64'h168); 
    ...
    // ( 0x168 .. 0x170 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 28'h168   ) begin
    ...
    // ( 0x8000 .. 0xc000 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 28'h8000   ) begin

...
module soc_mm_interconnect_0 (
		...
		output wire [11:0] graphics_drawing_unit_0_avl_mm_slave_address,    //     graphics_drawing_unit_0_avl_mm_slave.address
		output wire        graphics_drawing_unit_0_avl_mm_slave_write,      //                                         .write
		output wire        graphics_drawing_unit_0_avl_mm_slave_read,       //                                         .read
		input  wire [31:0] graphics_drawing_unit_0_avl_mm_slave_readdata,   //                                         .readdata
		output wire [31:0] graphics_drawing_unit_0_avl_mm_slave_writedata,  //                                         .writedata
		output wire [3:0]  graphics_drawing_unit_0_avl_mm_slave_byteenable, //                                         .byteenable
		output wire        graphics_drawing_unit_0_avl_mm_slave_chipselect, //                                         .chipselect
	...
	wire   [31:0] graphics_drawing_unit_0_avl_mm_slave_agent_m0_readdata;                             // graphics_drawing_unit_0_avl_mm_slave_translator:uav_readdata -> graphics_drawing_unit_0_avl_mm_slave_agent:m0_readdata
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_m0_waitrequest;                          // graphics_drawing_unit_0_avl_mm_slave_translator:uav_waitrequest -> graphics_drawing_unit_0_avl_mm_slave_agent:m0_waitrequest
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_m0_debugaccess;                          // graphics_drawing_unit_0_avl_mm_slave_agent:m0_debugaccess -> graphics_drawing_unit_0_avl_mm_slave_translator:uav_debugaccess
	wire   [27:0] graphics_drawing_unit_0_avl_mm_slave_agent_m0_address;                              // graphics_drawing_unit_0_avl_mm_slave_agent:m0_address -> graphics_drawing_unit_0_avl_mm_slave_translator:uav_address
	wire    [3:0] graphics_drawing_unit_0_avl_mm_slave_agent_m0_byteenable;                           // graphics_drawing_unit_0_avl_mm_slave_agent:m0_byteenable -> graphics_drawing_unit_0_avl_mm_slave_translator:uav_byteenable
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_m0_read;                                 // graphics_drawing_unit_0_avl_mm_slave_agent:m0_read -> graphics_drawing_unit_0_avl_mm_slave_translator:uav_read
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_m0_readdatavalid;                        // graphics_drawing_unit_0_avl_mm_slave_translator:uav_readdatavalid -> graphics_drawing_unit_0_avl_mm_slave_agent:m0_readdatavalid
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_m0_lock;                                 // graphics_drawing_unit_0_avl_mm_slave_agent:m0_lock -> graphics_drawing_unit_0_avl_mm_slave_translator:uav_lock
	wire   [31:0] graphics_drawing_unit_0_avl_mm_slave_agent_m0_writedata;                            // graphics_drawing_unit_0_avl_mm_slave_agent:m0_writedata -> graphics_drawing_unit_0_avl_mm_slave_translator:uav_writedata
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_m0_write;                                // graphics_drawing_unit_0_avl_mm_slave_agent:m0_write -> graphics_drawing_unit_0_avl_mm_slave_translator:uav_write
	wire    [2:0] graphics_drawing_unit_0_avl_mm_slave_agent_m0_burstcount;                           // graphics_drawing_unit_0_avl_mm_slave_agent:m0_burstcount -> graphics_drawing_unit_0_avl_mm_slave_translator:uav_burstcount
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_rf_source_valid;                         // graphics_drawing_unit_0_avl_mm_slave_agent:rf_source_valid -> graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo:in_valid
	wire  [106:0] graphics_drawing_unit_0_avl_mm_slave_agent_rf_source_data;                          // graphics_drawing_unit_0_avl_mm_slave_agent:rf_source_data -> graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo:in_data
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_rf_source_ready;                         // graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo:in_ready -> graphics_drawing_unit_0_avl_mm_slave_agent:rf_source_ready
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_rf_source_startofpacket;                 // graphics_drawing_unit_0_avl_mm_slave_agent:rf_source_startofpacket -> graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo:in_startofpacket
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_rf_source_endofpacket;                   // graphics_drawing_unit_0_avl_mm_slave_agent:rf_source_endofpacket -> graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo:in_endofpacket
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo_out_valid;                      // graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo:out_valid -> graphics_drawing_unit_0_avl_mm_slave_agent:rf_sink_valid
	wire  [106:0] graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo_out_data;                       // graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo:out_data -> graphics_drawing_unit_0_avl_mm_slave_agent:rf_sink_data
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo_out_ready;                      // graphics_drawing_unit_0_avl_mm_slave_agent:rf_sink_ready -> graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo:out_ready
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo_out_startofpacket;              // graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo:out_startofpacket -> graphics_drawing_unit_0_avl_mm_slave_agent:rf_sink_startofpacket
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo_out_endofpacket;                // graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo:out_endofpacket -> graphics_drawing_unit_0_avl_mm_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> graphics_drawing_unit_0_avl_mm_slave_agent:cp_valid
	wire  [105:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> graphics_drawing_unit_0_avl_mm_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // graphics_drawing_unit_0_avl_mm_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [11:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> graphics_drawing_unit_0_avl_mm_slave_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> graphics_drawing_unit_0_avl_mm_slave_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> graphics_drawing_unit_0_avl_mm_slave_agent:cp_endofpacket
	...
	wire   [11:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> usb_irq_s1_agent:cp_channel
	...
	wire   [11:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> usb_gpx_s1_agent:cp_channel
	...
	wire   [11:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> usb_rst_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_011_src_data;                                                               // cmd_mux_011:src_data -> spi_0_spi_control_port_agent:cp_data
	...
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_rp_valid;                                // graphics_drawing_unit_0_avl_mm_slave_agent:rp_valid -> router_003:sink_valid
	wire  [105:0] graphics_drawing_unit_0_avl_mm_slave_agent_rp_data;                                 // graphics_drawing_unit_0_avl_mm_slave_agent:rp_data -> router_003:sink_data
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_rp_ready;                                // router_003:sink_ready -> graphics_drawing_unit_0_avl_mm_slave_agent:rp_ready
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_rp_startofpacket;                        // graphics_drawing_unit_0_avl_mm_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_rp_endofpacket;                          // graphics_drawing_unit_0_avl_mm_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [105:0] spi_0_spi_control_port_agent_rp_data;                                               // spi_0_spi_control_port_agent:rp_data -> router_013:sink_data
	...
	wire   [11:0] cmd_demux_001_src6_channel;                                                         // cmd_demux_001:src6_channel -> crosser_001:in_channel
	...
	wire   [11:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_001:sink6_channel
	...
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_rdata_fifo_src_valid;                    // graphics_drawing_unit_0_avl_mm_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] graphics_drawing_unit_0_avl_mm_slave_agent_rdata_fifo_src_data;                     // graphics_drawing_unit_0_avl_mm_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          graphics_drawing_unit_0_avl_mm_slave_agent_rdata_fifo_src_ready;                    // avalon_st_adapter_001:in_0_ready -> graphics_drawing_unit_0_avl_mm_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> graphics_drawing_unit_0_avl_mm_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> graphics_drawing_unit_0_avl_mm_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                                  // graphics_drawing_unit_0_avl_mm_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> graphics_drawing_unit_0_avl_mm_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) graphics_drawing_unit_0_avl_mm_slave_translator (
		.clk                    (clk_0_clk_clk),                                               //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset),              //                    reset.reset
		.uav_address            (graphics_drawing_unit_0_avl_mm_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (graphics_drawing_unit_0_avl_mm_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (graphics_drawing_unit_0_avl_mm_slave_agent_m0_read),          //                         .read
		.uav_write              (graphics_drawing_unit_0_avl_mm_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (graphics_drawing_unit_0_avl_mm_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (graphics_drawing_unit_0_avl_mm_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (graphics_drawing_unit_0_avl_mm_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (graphics_drawing_unit_0_avl_mm_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (graphics_drawing_unit_0_avl_mm_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (graphics_drawing_unit_0_avl_mm_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (graphics_drawing_unit_0_avl_mm_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (graphics_drawing_unit_0_avl_mm_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (graphics_drawing_unit_0_avl_mm_slave_write),                  //                         .write
		.av_read                (graphics_drawing_unit_0_avl_mm_slave_read),                   //                         .read
		.av_readdata            (graphics_drawing_unit_0_avl_mm_slave_readdata),               //                         .readdata
		.av_writedata           (graphics_drawing_unit_0_avl_mm_slave_writedata),              //                         .writedata
		.av_byteenable          (graphics_drawing_unit_0_avl_mm_slave_byteenable),             //                         .byteenable
		.av_chipselect          (graphics_drawing_unit_0_avl_mm_slave_chipselect),             //                         .chipselect
		.av_begintransfer       (),                                                            //              (terminated)
		.av_beginbursttransfer  (),                                                            //              (terminated)
		.av_burstcount          (),                                                            //              (terminated)
		.av_readdatavalid       (1'b0),                                                        //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) graphics_drawing_unit_0_avl_mm_slave_agent (
		.clk                     (clk_0_clk_clk),                                                         //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                        //       clk_reset.reset
		.m0_address              (graphics_drawing_unit_0_avl_mm_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (graphics_drawing_unit_0_avl_mm_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (graphics_drawing_unit_0_avl_mm_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (graphics_drawing_unit_0_avl_mm_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (graphics_drawing_unit_0_avl_mm_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (graphics_drawing_unit_0_avl_mm_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (graphics_drawing_unit_0_avl_mm_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (graphics_drawing_unit_0_avl_mm_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (graphics_drawing_unit_0_avl_mm_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (graphics_drawing_unit_0_avl_mm_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (graphics_drawing_unit_0_avl_mm_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (graphics_drawing_unit_0_avl_mm_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (graphics_drawing_unit_0_avl_mm_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (graphics_drawing_unit_0_avl_mm_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (graphics_drawing_unit_0_avl_mm_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (graphics_drawing_unit_0_avl_mm_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (graphics_drawing_unit_0_avl_mm_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (graphics_drawing_unit_0_avl_mm_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (graphics_drawing_unit_0_avl_mm_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (graphics_drawing_unit_0_avl_mm_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (graphics_drawing_unit_0_avl_mm_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                                     // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                                     //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                                      //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                                     //                .error
		.rdata_fifo_src_ready    (graphics_drawing_unit_0_avl_mm_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (graphics_drawing_unit_0_avl_mm_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (graphics_drawing_unit_0_avl_mm_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                                 //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                                   //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                                         //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                        // clk_reset.reset
		.in_data           (graphics_drawing_unit_0_avl_mm_slave_agent_rf_source_data),             //        in.data
		.in_valid          (graphics_drawing_unit_0_avl_mm_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (graphics_drawing_unit_0_avl_mm_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (graphics_drawing_unit_0_avl_mm_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (graphics_drawing_unit_0_avl_mm_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (graphics_drawing_unit_0_avl_mm_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                                 // (terminated)
		.csr_read          (1'b0),                                                                  // (terminated)
		.csr_write         (1'b0),                                                                  // (terminated)
		.csr_readdata      (),                                                                      // (terminated)
	...
	soc_mm_interconnect_0_router_002 router_003 (
		.sink_ready         (graphics_drawing_unit_0_avl_mm_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (graphics_drawing_unit_0_avl_mm_slave_agent_rp_valid),         //          .valid
		.sink_data          (graphics_drawing_unit_0_avl_mm_slave_agent_rp_data),          //          .data
		.sink_startofpacket (graphics_drawing_unit_0_avl_mm_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (graphics_drawing_unit_0_avl_mm_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                               //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),              // clk_reset.reset
	...
	soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (graphics_drawing_unit_0_avl_mm_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (graphics_drawing_unit_0_avl_mm_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (graphics_drawing_unit_0_avl_mm_slave_agent_rdata_fifo_src_ready), //         .ready
	...
	soc_mm_interconnect_0_avalon_st_adapter_006 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),

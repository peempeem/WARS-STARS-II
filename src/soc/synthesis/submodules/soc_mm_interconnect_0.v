...
module soc_mm_interconnect_0 (
		...
		input  wire        I2C_reset_reset_bridge_in_reset_reset,           //           I2C_reset_reset_bridge_in_reset.reset
	...
	wire          rsp_mux_src_valid;                                                                  // rsp_mux:src_valid -> I2C_avalon_master_agent:rp_valid
	wire  [109:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> I2C_avalon_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                  // I2C_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [10:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> I2C_avalon_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                          // rsp_mux:src_startofpacket -> I2C_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                            // rsp_mux:src_endofpacket -> I2C_avalon_master_agent:rp_endofpacket
	...
	wire    [2:0] vga_display_0_avalon_master_translator_avalon_universal_master_0_burstcount;        // vga_display_0_avalon_master_translator:uav_burstcount -> vga_display_0_avalon_master_agent:av_burstcount
	wire          rsp_mux_003_src_valid;                                                              // rsp_mux_003:src_valid -> vga_display_0_avalon_master_agent:rp_valid
	wire  [109:0] rsp_mux_003_src_data;                                                               // rsp_mux_003:src_data -> vga_display_0_avalon_master_agent:rp_data
	wire          rsp_mux_003_src_ready;                                                              // vga_display_0_avalon_master_agent:rp_ready -> rsp_mux_003:src_ready
	wire   [10:0] rsp_mux_003_src_channel;                                                            // rsp_mux_003:src_channel -> vga_display_0_avalon_master_agent:rp_channel
	wire          rsp_mux_003_src_startofpacket;                                                      // rsp_mux_003:src_startofpacket -> vga_display_0_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_003_src_endofpacket;                                                        // rsp_mux_003:src_endofpacket -> vga_display_0_avalon_master_agent:rp_endofpacket
	...
	wire  [109:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                                  // nios2_gen2_0_debug_mem_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [10:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> nios2_gen2_0_debug_mem_slave_agent:cp_channel
	...
	wire  [110:0] usb_irq_s1_agent_rf_source_data;                                                    // usb_irq_s1_agent:rf_source_data -> usb_irq_s1_agent_rsp_fifo:in_data
	...
	wire  [110:0] usb_irq_s1_agent_rsp_fifo_out_data;                                                 // usb_irq_s1_agent_rsp_fifo:out_data -> usb_irq_s1_agent:rf_sink_data
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> usb_irq_s1_agent:cp_valid
	wire  [109:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> usb_irq_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // usb_irq_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [10:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> usb_irq_s1_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> usb_irq_s1_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> usb_irq_s1_agent:cp_endofpacket
	...
	wire  [110:0] usb_gpx_s1_agent_rf_source_data;                                                    // usb_gpx_s1_agent:rf_source_data -> usb_gpx_s1_agent_rsp_fifo:in_data
	...
	wire  [110:0] usb_gpx_s1_agent_rsp_fifo_out_data;                                                 // usb_gpx_s1_agent_rsp_fifo:out_data -> usb_gpx_s1_agent:rf_sink_data
	...
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> usb_gpx_s1_agent:cp_valid
	wire  [109:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> usb_gpx_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // usb_gpx_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [10:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> usb_gpx_s1_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> usb_gpx_s1_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> usb_gpx_s1_agent:cp_endofpacket
	...
	wire  [110:0] usb_rst_s1_agent_rf_source_data;                                                    // usb_rst_s1_agent:rf_source_data -> usb_rst_s1_agent_rsp_fifo:in_data
	...
	wire  [110:0] usb_rst_s1_agent_rsp_fifo_out_data;                                                 // usb_rst_s1_agent_rsp_fifo:out_data -> usb_rst_s1_agent:rf_sink_data
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> usb_rst_s1_agent:cp_valid
	wire  [109:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> usb_rst_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // usb_rst_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [10:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> usb_rst_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> usb_rst_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> usb_rst_s1_agent:cp_endofpacket
	...
	wire   [10:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire  [110:0] spi_0_spi_control_port_agent_rf_source_data;                                        // spi_0_spi_control_port_agent:rf_source_data -> spi_0_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [110:0] spi_0_spi_control_port_agent_rsp_fifo_out_data;                                     // spi_0_spi_control_port_agent_rsp_fifo:out_data -> spi_0_spi_control_port_agent:rf_sink_data
	...
	wire  [109:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> spi_0_spi_control_port_agent:cp_data
	...
	wire          i2c_avalon_master_agent_cp_valid;                                                   // I2C_avalon_master_agent:cp_valid -> router:sink_valid
	wire  [109:0] i2c_avalon_master_agent_cp_data;                                                    // I2C_avalon_master_agent:cp_data -> router:sink_data
	wire          i2c_avalon_master_agent_cp_ready;                                                   // router:sink_ready -> I2C_avalon_master_agent:cp_ready
	wire          i2c_avalon_master_agent_cp_startofpacket;                                           // I2C_avalon_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          i2c_avalon_master_agent_cp_endofpacket;                                             // I2C_avalon_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          vga_display_0_avalon_master_agent_cp_valid;                                         // vga_display_0_avalon_master_agent:cp_valid -> router_003:sink_valid
	wire  [109:0] vga_display_0_avalon_master_agent_cp_data;                                          // vga_display_0_avalon_master_agent:cp_data -> router_003:sink_data
	wire          vga_display_0_avalon_master_agent_cp_ready;                                         // router_003:sink_ready -> vga_display_0_avalon_master_agent:cp_ready
	wire          vga_display_0_avalon_master_agent_cp_startofpacket;                                 // vga_display_0_avalon_master_agent:cp_startofpacket -> router_003:sink_startofpacket
	wire          vga_display_0_avalon_master_agent_cp_endofpacket;                                   // vga_display_0_avalon_master_agent:cp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [109:0] sdram_pll_pll_slave_agent_rp_data;                                                  // sdram_pll_pll_slave_agent:rp_data -> router_007:sink_data
	...
	wire  [109:0] usb_irq_s1_agent_rp_data;                                                           // usb_irq_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [109:0] usb_gpx_s1_agent_rp_data;                                                           // usb_gpx_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [109:0] usb_rst_s1_agent_rp_data;                                                           // usb_rst_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [109:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [109:0] spi_0_spi_control_port_agent_rp_data;                                               // spi_0_spi_control_port_agent:rp_data -> router_014:sink_data
	...
	wire  [109:0] cmd_demux_002_src4_data;                                                            // cmd_demux_002:src4_data -> cmd_mux_004:sink1_data
	...
	wire  [109:0] cmd_demux_002_src5_data;                                                            // cmd_demux_002:src5_data -> cmd_mux_005:sink1_data
	...
	wire  [109:0] cmd_demux_002_src6_data;                                                            // cmd_demux_002:src6_data -> cmd_mux_006:sink1_data
	...
	wire  [109:0] cmd_demux_002_src7_data;                                                            // cmd_demux_002:src7_data -> cmd_mux_007:sink1_data
	...
	wire  [109:0] cmd_demux_002_src8_data;                                                            // cmd_demux_002:src8_data -> cmd_mux_008:sink1_data
	...
	wire  [109:0] cmd_demux_002_src10_data;                                                           // cmd_demux_002:src10_data -> cmd_mux_010:sink1_data
	...
	wire  [109:0] rsp_demux_004_src1_data;                                                            // rsp_demux_004:src1_data -> rsp_mux_002:sink4_data
	...
	wire  [109:0] rsp_demux_005_src1_data;                                                            // rsp_demux_005:src1_data -> rsp_mux_002:sink5_data
	...
	wire  [109:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> rsp_mux_002:sink6_data
	...
	wire  [109:0] rsp_demux_007_src1_data;                                                            // rsp_demux_007:src1_data -> rsp_mux_002:sink7_data
	...
	wire  [109:0] rsp_demux_008_src1_data;                                                            // rsp_demux_008:src1_data -> rsp_mux_002:sink8_data
	...
	wire  [109:0] rsp_demux_010_src1_data;                                                            // rsp_demux_010:src1_data -> rsp_mux_002:sink10_data
	...
	wire   [10:0] router_013_src_channel;                                                             // router_013:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire  [109:0] sdram_s1_rsp_width_adapter_src_data;                                                // sdram_s1_rsp_width_adapter:out_data -> rsp_demux_009:sink_data
	...
	wire  [109:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> sdram_s1_cmd_width_adapter:in_data
	...
	wire   [10:0] cmd_demux_001_src9_channel;                                                         // cmd_demux_001:src9_channel -> crosser:in_channel
	...
	wire          cmd_demux_002_src9_valid;                                                           // cmd_demux_002:src9_valid -> crosser_001:in_valid
	wire  [109:0] cmd_demux_002_src9_data;                                                            // cmd_demux_002:src9_data -> crosser_001:in_data
	wire          cmd_demux_002_src9_ready;                                                           // crosser_001:in_ready -> cmd_demux_002:src9_ready
	wire   [10:0] cmd_demux_002_src9_channel;                                                         // cmd_demux_002:src9_channel -> crosser_001:in_channel
	wire          cmd_demux_002_src9_startofpacket;                                                   // cmd_demux_002:src9_startofpacket -> crosser_001:in_startofpacket
	wire          cmd_demux_002_src9_endofpacket;                                                     // cmd_demux_002:src9_endofpacket -> crosser_001:in_endofpacket
	...
	wire   [10:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_009:sink1_channel
	...
	wire  [109:0] cmd_demux_003_src0_data;                                                            // cmd_demux_003:src0_data -> crosser_002:in_data
	wire          cmd_demux_003_src0_ready;                                                           // crosser_002:in_ready -> cmd_demux_003:src0_ready
	wire   [10:0] cmd_demux_003_src0_channel;                                                         // cmd_demux_003:src0_channel -> crosser_002:in_channel
	...
	wire          crosser_002_out_valid;                                                              // crosser_002:out_valid -> cmd_mux_009:sink2_valid
	wire  [109:0] crosser_002_out_data;                                                               // crosser_002:out_data -> cmd_mux_009:sink2_data
	wire          crosser_002_out_ready;                                                              // cmd_mux_009:sink2_ready -> crosser_002:out_ready
	wire   [10:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> cmd_mux_009:sink2_channel
	wire          crosser_002_out_startofpacket;                                                      // crosser_002:out_startofpacket -> cmd_mux_009:sink2_startofpacket
	wire          crosser_002_out_endofpacket;                                                        // crosser_002:out_endofpacket -> cmd_mux_009:sink2_endofpacket
	...
	wire   [10:0] rsp_demux_009_src0_channel;                                                         // rsp_demux_009:src0_channel -> crosser_003:in_channel
	...
	wire          crosser_003_out_valid;                                                              // crosser_003:out_valid -> rsp_mux_001:sink9_valid
	wire  [109:0] crosser_003_out_data;                                                               // crosser_003:out_data -> rsp_mux_001:sink9_data
	wire          crosser_003_out_ready;                                                              // rsp_mux_001:sink9_ready -> crosser_003:out_ready
	wire   [10:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_001:sink9_channel
	wire          crosser_003_out_startofpacket;                                                      // crosser_003:out_startofpacket -> rsp_mux_001:sink9_startofpacket
	wire          crosser_003_out_endofpacket;                                                        // crosser_003:out_endofpacket -> rsp_mux_001:sink9_endofpacket
	wire          rsp_demux_009_src1_valid;                                                           // rsp_demux_009:src1_valid -> crosser_004:in_valid
	wire  [109:0] rsp_demux_009_src1_data;                                                            // rsp_demux_009:src1_data -> crosser_004:in_data
	wire          rsp_demux_009_src1_ready;                                                           // crosser_004:in_ready -> rsp_demux_009:src1_ready
	wire   [10:0] rsp_demux_009_src1_channel;                                                         // rsp_demux_009:src1_channel -> crosser_004:in_channel
	wire          rsp_demux_009_src1_startofpacket;                                                   // rsp_demux_009:src1_startofpacket -> crosser_004:in_startofpacket
	wire          rsp_demux_009_src1_endofpacket;                                                     // rsp_demux_009:src1_endofpacket -> crosser_004:in_endofpacket
	wire          crosser_004_out_valid;                                                              // crosser_004:out_valid -> rsp_mux_002:sink9_valid
	wire  [109:0] crosser_004_out_data;                                                               // crosser_004:out_data -> rsp_mux_002:sink9_data
	wire          crosser_004_out_ready;                                                              // rsp_mux_002:sink9_ready -> crosser_004:out_ready
	wire   [10:0] crosser_004_out_channel;                                                            // crosser_004:out_channel -> rsp_mux_002:sink9_channel
	wire          crosser_004_out_startofpacket;                                                      // crosser_004:out_startofpacket -> rsp_mux_002:sink9_startofpacket
	wire          crosser_004_out_endofpacket;                                                        // crosser_004:out_endofpacket -> rsp_mux_002:sink9_endofpacket
	wire          rsp_demux_009_src2_valid;                                                           // rsp_demux_009:src2_valid -> crosser_005:in_valid
	wire  [109:0] rsp_demux_009_src2_data;                                                            // rsp_demux_009:src2_data -> crosser_005:in_data
	wire          rsp_demux_009_src2_ready;                                                           // crosser_005:in_ready -> rsp_demux_009:src2_ready
	wire   [10:0] rsp_demux_009_src2_channel;                                                         // rsp_demux_009:src2_channel -> crosser_005:in_channel
	wire          rsp_demux_009_src2_startofpacket;                                                   // rsp_demux_009:src2_startofpacket -> crosser_005:in_startofpacket
	wire          rsp_demux_009_src2_endofpacket;                                                     // rsp_demux_009:src2_endofpacket -> crosser_005:in_endofpacket
	wire          crosser_005_out_valid;                                                              // crosser_005:out_valid -> rsp_mux_003:sink0_valid
	wire  [109:0] crosser_005_out_data;                                                               // crosser_005:out_data -> rsp_mux_003:sink0_data
	wire          crosser_005_out_ready;                                                              // rsp_mux_003:sink0_ready -> crosser_005:out_ready
	wire   [10:0] crosser_005_out_channel;                                                            // crosser_005:out_channel -> rsp_mux_003:sink0_channel
	...
	wire          usb_irq_s1_agent_rdata_fifo_src_valid;                                              // usb_irq_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] usb_irq_s1_agent_rdata_fifo_src_data;                                               // usb_irq_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          usb_irq_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_004:in_0_ready -> usb_irq_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> usb_irq_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> usb_irq_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                  // usb_irq_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> usb_irq_s1_agent:rdata_fifo_sink_error
	wire          usb_gpx_s1_agent_rdata_fifo_src_valid;                                              // usb_gpx_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] usb_gpx_s1_agent_rdata_fifo_src_data;                                               // usb_gpx_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          usb_gpx_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_005:in_0_ready -> usb_gpx_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> usb_gpx_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> usb_gpx_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                  // usb_gpx_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> usb_gpx_s1_agent:rdata_fifo_sink_error
	wire          usb_rst_s1_agent_rdata_fifo_src_valid;                                              // usb_rst_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] usb_rst_s1_agent_rdata_fifo_src_data;                                               // usb_rst_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          usb_rst_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_006:in_0_ready -> usb_rst_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> usb_rst_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> usb_rst_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // usb_rst_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> usb_rst_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_master_translator #(
		...
		.reset                  (I2C_reset_reset_bridge_in_reset_reset),                                //                     reset.reset
	...
	altera_merlin_master_agent #(
		...
		.clk                   (clk_0_clk_clk),                                                        //       clk.clk
		.reset                 (I2C_reset_reset_bridge_in_reset_reset),                                // clk_reset.reset
	...
	soc_mm_interconnect_0_cmd_demux cmd_demux_003 (
		.clk                (clk_0_clk_clk),                                   //       clk.clk
		.reset              (vga_display_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_rsp_mux rsp_mux_003 (
		.clk                 (clk_0_clk_clk),                                   //       clk.clk
		.reset               (vga_display_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (I2C_reset_reset_bridge_in_reset_reset),   //  in_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_clk           (sdram_pll_c0_clk),                        //       out_clk.clk
		.out_reset         (sdram_reset_reset_bridge_in_reset_reset), // out_clk_reset.reset
		.in_ready          (cmd_demux_002_src9_ready),                //            in.ready
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (I2C_reset_reset_bridge_in_reset_reset),   // out_clk_reset.reset
	...
	soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (I2C_reset_reset_bridge_in_reset_reset),                   // in_rst_0.reset
	...
	soc_mm_interconnect_0_avalon_st_adapter_009 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),

...
module soc_mm_interconnect_1 (
	...
	wire  [16:0] usb_irq_s1_agent_m0_address;                                                        // usb_irq_s1_agent:m0_address -> usb_irq_s1_translator:uav_address
	...
	wire  [95:0] usb_irq_s1_agent_rf_source_data;                                                    // usb_irq_s1_agent:rf_source_data -> usb_irq_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] usb_irq_s1_agent_rsp_fifo_out_data;                                                 // usb_irq_s1_agent_rsp_fifo:out_data -> usb_irq_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> usb_irq_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // usb_irq_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [9:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> usb_irq_s1_agent:cp_channel
	...
	wire  [16:0] usb_gpx_s1_agent_m0_address;                                                        // usb_gpx_s1_agent:m0_address -> usb_gpx_s1_translator:uav_address
	...
	wire  [95:0] usb_gpx_s1_agent_rf_source_data;                                                    // usb_gpx_s1_agent:rf_source_data -> usb_gpx_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] usb_gpx_s1_agent_rsp_fifo_out_data;                                                 // usb_gpx_s1_agent_rsp_fifo:out_data -> usb_gpx_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> usb_gpx_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // usb_gpx_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [9:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> usb_gpx_s1_agent:cp_channel
	...
	wire  [16:0] usb_rst_s1_agent_m0_address;                                                        // usb_rst_s1_agent:m0_address -> usb_rst_s1_translator:uav_address
	...
	wire  [95:0] usb_rst_s1_agent_rf_source_data;                                                    // usb_rst_s1_agent:rf_source_data -> usb_rst_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] usb_rst_s1_agent_rsp_fifo_out_data;                                                 // usb_rst_s1_agent_rsp_fifo:out_data -> usb_rst_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> usb_rst_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // usb_rst_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [9:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> usb_rst_s1_agent:cp_channel
	...
	wire  [94:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> spi_0_spi_control_port_agent:cp_data
	...
	wire         usb_irq_s1_agent_rp_valid;                                                          // usb_irq_s1_agent:rp_valid -> router_006:sink_valid
	wire  [94:0] usb_irq_s1_agent_rp_data;                                                           // usb_irq_s1_agent:rp_data -> router_006:sink_data
	wire         usb_irq_s1_agent_rp_ready;                                                          // router_006:sink_ready -> usb_irq_s1_agent:rp_ready
	wire         usb_irq_s1_agent_rp_startofpacket;                                                  // usb_irq_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         usb_irq_s1_agent_rp_endofpacket;                                                    // usb_irq_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         usb_gpx_s1_agent_rp_valid;                                                          // usb_gpx_s1_agent:rp_valid -> router_007:sink_valid
	wire  [94:0] usb_gpx_s1_agent_rp_data;                                                           // usb_gpx_s1_agent:rp_data -> router_007:sink_data
	wire         usb_gpx_s1_agent_rp_ready;                                                          // router_007:sink_ready -> usb_gpx_s1_agent:rp_ready
	wire         usb_gpx_s1_agent_rp_startofpacket;                                                  // usb_gpx_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         usb_gpx_s1_agent_rp_endofpacket;                                                    // usb_gpx_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         usb_rst_s1_agent_rp_valid;                                                          // usb_rst_s1_agent:rp_valid -> router_008:sink_valid
	wire  [94:0] usb_rst_s1_agent_rp_data;                                                           // usb_rst_s1_agent:rp_data -> router_008:sink_data
	wire         usb_rst_s1_agent_rp_ready;                                                          // router_008:sink_ready -> usb_rst_s1_agent:rp_ready
	wire         usb_rst_s1_agent_rp_startofpacket;                                                  // usb_rst_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         usb_rst_s1_agent_rp_endofpacket;                                                    // usb_rst_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire  [94:0] spi_0_spi_control_port_agent_rp_data;                                               // spi_0_spi_control_port_agent:rp_data -> router_011:sink_data
	...
	soc_mm_interconnect_1_router_002 router_008 (
	...
	soc_mm_interconnect_1_router_002 router_009 (
	...
	soc_mm_interconnect_1_router_002 router_010 (
	...
	soc_mm_interconnect_1_router_002 router_011 (
	...
	soc_mm_interconnect_1_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_1_cmd_mux cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_1_cmd_mux cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_1_cmd_mux cmd_mux_009 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_1_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_1_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_1_rsp_demux rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_1_rsp_demux rsp_demux_009 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset

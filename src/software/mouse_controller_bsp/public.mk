...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2190
SOPC_SYSID_FLAG += --sidp=0x2190
ELF_PATCH_FLAG  += --sidp 0x2190

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1651368365
SOPC_SYSID_FLAG += --timestamp=1651368365
ELF_PATCH_FLAG  += --timestamp 1651368365
